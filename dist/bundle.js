...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      fetch("" + base_url + category + api_key).then(function (res) {
        return res.json();
      }).then(function (_ref2) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_News2.default, { articles: this.state.articles })
      );
    }
  }]);
...
var _NewsItem = __webpack_require__(30);
...
var News = function (_Component) {
  ...
  _createClass(News, [{
    key: "renderNewsItems",
    value: function renderNewsItems() {
      return this.props.articles.map(function (article, i) {
        return _react2.default.createElement(_NewsItem2.default, { key: i, article: article });
      });
    }
  }, {
    key: "render",
